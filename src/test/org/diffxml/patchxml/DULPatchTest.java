...
public class DULPatchTest {
  ...
  public final void testSimpleInsert() {
    ...
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<insert parent=\"/a\" nodetype=\"1\" "
            + "childno=\"1\" name=\"b\"/>" + "</delta>");
  ...
  public final void testInsertAfterText() {
    ...
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<insert parent=\"/a\" nodetype=\"1\" "
            + "childno=\"2\" name=\"b\" charpos=\"5\" />" + "</delta>");
  ...
  public final void testInsertBeforeText() {
    ...
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<insert parent=\"/a\" nodetype=\"1\" "
            + "childno=\"1\" name=\"b\" charpos=\"1\" />" + "</delta>");
  ...
  public final void testInsertIntoText() {
    ...
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<insert parent=\"/a\" nodetype=\"1\" "
            + "childno=\"2\" name=\"b\" charpos=\"2\" />" + "</delta>");
  ...
  public final void testInsertIntoText2() {
    ...
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<insert charpos=\"2\" childno=\"2\" name=\"p\" "
            + "nodetype=\"1\" parent=\"/node()[1]\"/>" + "</delta>");
    ...
    try {
      ...
      assertEquals("y", text1.getNextSibling().getNextSibling().getNodeValue());
    } catch (PatchFormatException e) {
      fail("Caught exception " + e);
    }
  }
  ...
  public final void testInsertingAttr() {
    ...
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<insert parent=\"/a/node()[1]\" nodetype=\"2\" "
            + "name=\"attr\">val</insert>" + "</delta>");
  ...
  public final void testInsertingComment() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a></a>");
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<insert parent=\"/a\" nodetype=\""
            + Node.COMMENT_NODE + "\"" + ">val</insert>" + "</delta>");
  ...
  public final void testInsertingCDATA() {
    ...
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<insert parent=\"/a\" nodetype=\""
            + Node.CDATA_SECTION_NODE + "\"" + ">val</insert>" + "</delta>");
  ...
  public final void testDeleteAttribute() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a><b attr=\"val\"/></a>");
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<delete node=\"/a/node()[1]/@attr\" />" + "</delta>");
  ...
  public final void testDeleteComment() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a><!-- comment --></a>");
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<delete node=\"/a/node()[1]\" />" + "</delta>");
  ...
  public final void testDeleteText() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a>12<b/>3456</a>");
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<delete node=\"/a/node()[1]\" />" + "</delta>");
    ...
    patch = TestDocHelper
        .createDocument("<delta>" + "<delete node=\"/a/node()[2]\" "
            + "charpos=\"2\" length=\"2\"/>" + "</delta>");
    try {
      (new DULPatch()).apply(doc1, patch);
      assertTrue(
          doc1.getDocumentElement().getFirstChild().getNextSibling() != null);
  ...
  public final void testSimpleMove() {
    ...
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<move node=\"/a/node()[2]/node()[1]\" "
            + "parent=\"/a/node()[1]\" childno=\"1\" />" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);
      assertEquals("d", doc1.getDocumentElement().getFirstChild()
          .getFirstChild().getNodeName());
      assertNull(doc1.getDocumentElement().getFirstChild().getNextSibling()
          .getFirstChild());
    } catch (PatchFormatException e) {
      fail("Caught exception " + e);
    }
  ...
  public final void testMoveIntoText() {
    ...
    Document doc1 = TestDocHelper
        .createDocument("<a><b>text</b><c><d/></c></a>");
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<move node=\"/a/node()[2]/node()[1]\" "
            + "parent=\"/a/node()[1]\" childno=\"2\" " + "new_charpos=\"3\"/>"
            + "</delta>");
    ...
    try {
      ...
      assertEquals("d", b.getFirstChild().getNextSibling().getNodeName());
      assertEquals("xt",
          b.getFirstChild().getNextSibling().getNextSibling().getNodeValue());
    } catch (PatchFormatException e) {
      fail("Caught exception " + e);
    }
  }
  ...
  public final void testMovePartOfText() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a><b></b><c>text</c></a>");
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<move node=\"/a/node()[2]/node()[1]\" "
            + "parent=\"/a/node()[1]\" childno=\"1\" "
            + "old_charpos=\"2\" length=\"2\"/>" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);
      Node b = doc1.getDocumentElement().getFirstChild();
      assertEquals("tt", b.getNextSibling().getFirstChild().getNodeValue());
  ...
  public final void testMoveCount() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a><b/><c/><d/></a>");
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<move node=\"/a/node()[1]\" "
            + "parent=\"/a\" childno=\"2\"/>" + "</delta>");
  ...
  public final void testUpdateElement() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a><b/></a>");
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<update node=\"/a/b\">c</update>" + "</delta>");
  ...
  public final void testUpdateAttribute() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a><b attr=\"test\"/></a>");
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<update node=\"/a/b/@attr\">newval</update>" + "</delta>");
  ...
  public final void testInsertAtRoot() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a></a>");
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<insert parent=\"/\" nodetype=\"" + Node.COMMENT_NODE
            + "\" " + "childno=\"1\">comment</insert>" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);
      assertEquals("comment", doc1.getFirstChild().getNodeValue());
    } catch (PatchFormatException e) {
      fail("Caught exception " + e);
    }
  }
  ...
  public final void testCDATAInText() {
    ...
    Document doc1 = TestDocHelper
        .createDocument("<a>text1<![CDATA[text2]]>text3</a>");

    Document patch = TestDocHelper
        .createDocument("<delta>" + "<delete node=\"/a/node()[1]\" "
            + "charpos=\"3\" length=\"4\"/>" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);
      assertEquals("teext2text3", doc1.getDocumentElement().getTextContent());
  ...
  public final void testCDATAInText2() {
    ...
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<delete node=\"/a/node()[1]\" "
            + "charpos=\"9\" length=\"4\"/>" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);
      assertEquals("text1texxt3", doc1.getDocumentElement().getTextContent());
      // Shouldn't remove CDATA section
      assertEquals(Node.CDATA_SECTION_NODE, doc1.getDocumentElement()
          .getFirstChild().getNextSibling().getNodeType());
    } catch (PatchFormatException e) {
  ...
  public final void testRemoveCDATAFromText() {
    ...
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<delete node=\"/a/node()[1]\" "
            + "charpos=\"6\" length=\"5\"/>" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);
      doc1.normalize();
      assertEquals("text1text3", doc1.getDocumentElement().getTextContent());
      // Should only have 1 text node
      assertEquals(1, doc1.getDocumentElement().getChildNodes().getLength());
  ...
  public final void testInsertAfterCDATA() {
    ...
    Document patch = TestDocHelper.createDocument("<delta>"
        + "<insert parent=\"/a\" nodetype=\"" + Node.COMMENT_NODE + "\""
        + " childno=\"2\" charpos=\"11\"" + ">val</insert>" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);

      Node cdata = doc1.getDocumentElement().getFirstChild().getNextSibling();
      assertEquals(Node.CDATA_SECTION_NODE, cdata.getNodeType());
      assertEquals("text2", cdata.getNodeValue());
      assertEquals(Node.COMMENT_NODE, cdata.getNextSibling().getNodeType());
      assertEquals("text3",
  ...
  public final void testInsertBeforeCDATA() {
    ...
    Document patch = TestDocHelper.createDocument("<delta>"
        + "<insert parent=\"/a\" nodetype=\"" + Node.COMMENT_NODE + "\""
        + " childno=\"2\" charpos=\"6\"" + ">val</insert>" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);

      assertEquals("text1",
          doc1.getDocumentElement().getFirstChild().getNodeValue());
      Node comment = doc1.getDocumentElement().getFirstChild().getNextSibling();
      assertEquals(Node.COMMENT_NODE, comment.getNodeType());
      assertEquals(Node.CDATA_SECTION_NODE,
          comment.getNextSibling().getNodeType());
      assertEquals("text2", comment.getNextSibling().getNodeValue());
    } catch (PatchFormatException e) {
      fail("Caught exception " + e);
    }
  }
  ...
  public final void testInsertCommentIntoCDATA() {
    ...
    Document patch = TestDocHelper.createDocument("<delta>"
        + "<insert parent=\"/a\" nodetype=\"" + Node.COMMENT_NODE + "\""
        + " childno=\"2\" charpos=\"8\"" + ">val</insert>" + "</delta>");
    ...
    try {
      ...
      assertEquals("text1",
          doc1.getDocumentElement().getFirstChild().getNodeValue());
      Node cdata1 = doc1.getDocumentElement().getFirstChild().getNextSibling();
  ...
  public final void testInsertTextIntoCDATA() {
    ...
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<insert parent=\"/a\" nodetype=\"" + Node.TEXT_NODE + "\""
            + " childno=\"2\" charpos=\"8\"" + ">val</insert>" + "</delta>");
  ...
  public final void testMoveCDATA() {
    ...
    Document doc1 = TestDocHelper
        .createDocument("<a>text1<![CDATA[text2]]>t<b/></a>");

    Document patch = TestDocHelper
        .createDocument("<delta>" + "<move node=\"/a/node()[1]\" "
            + "parent=\"/a/node()[2]\" childno=\"1\" "
            + "old_charpos=\"6\" length=\"5\"/>" + "</delta>");
    ...
    try {
      ...
      assertEquals("b", b.getNodeName());
      assertEquals(Node.CDATA_SECTION_NODE, b.getFirstChild().getNodeType());
   ...
   * 
   * Would be reasonable to throw an exception, as it is really an attempt to
   * move two nodes.
   * 
  ...
  public final void testInsertPI() {
    ...
    Document doc1 = TestDocHelper.createDocument("<a></a>");
    Document patch = TestDocHelper
        .createDocument("<delta>" + "<insert parent=\"/\" nodetype=\""
            + Node.PROCESSING_INSTRUCTION_NODE + "\" "
            + "childno=\"1\" name=\"piname\">pivalue</insert>" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);
      assertEquals("pivalue", doc1.getFirstChild().getNodeValue());
    } catch (PatchFormatException e) {
      fail("Caught exception " + e);
    }
  }
  ...
  public final void testInsertWithNamespace() {
    ...
    Document doc1 = TestDocHelper
        .createDocument("<a xmlns:n=\"http://example.com\"><n:b/></a>");
    Document patch = TestDocHelper.createDocument("<delta>"
        + "<insert parent=\"/a\" nodetype=\"" + Node.ELEMENT_NODE + "\" "
        + "childno=\"2\" name=\"c\" ns=\"http://new.com\"/>" + "</delta>");

    try {
      (new DULPatch()).apply(doc1, patch);
      assertEquals(1, doc1.getDocumentElement()
          .getElementsByTagNameNS("http://example.com", "b").getLength());
      assertEquals(1, doc1.getDocumentElement()
          .getElementsByTagNameNS("http://new.com", "c").getLength());
  ...
  public final void testDeletePI() {
    ...
    Document doc1 = TestDocHelper
        .createDocument("<?Processing Instruction?><a><b/></a>");
    Document patch = TestDocHelper.createDocument(
        "<delta>" + "<delete node=\"/node()[1]\" />" + "</delta>");
